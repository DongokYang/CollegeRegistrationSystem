...
namespace BITCollegeWindows.ServiceReference1 {
    ...
    public interface ICollegeRegistration {
        ...
        System.Nullable<double> UpdateGrade(int registrationId, double grade, string notes);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICollegeRegistration/UpdateGrade", ReplyAction="http://tempuri.org/ICollegeRegistration/UpdateGradeResponse")]
        System.Threading.Tasks.Task<System.Nullable<double>> UpdateGradeAsync(int registrationId, double grade, string notes);
    }
    ...
    public partial class CollegeRegistrationClient : System.ServiceModel.ClientBase<BITCollegeWindows.ServiceReference1.ICollegeRegistration>, BITCollegeWindows.ServiceReference1.ICollegeRegistration {
        ...
        public System.Nullable<double> UpdateGrade(int registrationId, double grade, string notes) {
            return base.Channel.UpdateGrade(registrationId, grade, notes);
        }
        
        public System.Threading.Tasks.Task<System.Nullable<double>> UpdateGradeAsync(int registrationId, double grade, string notes) {
            return base.Channel.UpdateGradeAsync(registrationId, grade, notes);
        }
    }
}
